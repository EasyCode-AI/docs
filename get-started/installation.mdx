...
<Tabs>
  <Tab title="MacOS">
    ...
    <Frame>
      <img src="/images/quick-start/install-macos.gif" className="w-full h-full rounded-xl" alt="MacOS Installation Process" />
    </Frame>
    ...
    <Frame>
      <img src="/images/quick-start/setup.jpg" className="w-full h-full rounded-xl" alt="Setup Screenshot" />
    </Frame>
    ...
    <Note>
      ...
      <Frame>
        <img src="/images/quick-start/macos.png" className="w-full h-full rounded-xl" alt="Xcode Select Screenshot" />
      </Frame>
    </Note>
  </Tab>
  <Tab title="Windows">
    ...
    <Note>
      ...
      <Frame>
        <img src="/images/quick-start/electron.png" className="w-full h-full rounded-xl" alt="Electron Network Access Screenshot" />
      </Frame>
    </Note>
  </Tab>
  <Tab title="Linux">
