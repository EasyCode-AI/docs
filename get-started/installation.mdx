...
<Tabs>
  <Tab title="MacOS">
    <CardGroup cols={2}>
      <Card title="Apple Silicon" icon="download" horizontal href="https://update.easycode.ai/download/stable/02ec53339c7805842c6fbccb6039d71823f2b9d6/EasyCode-Installer.dmg">
        M Series Macs
      </Card>
  ...
  <Tab title="Windows">
    <CardGroup cols={2}>
      <Card title="Windows x64" icon="download" horizontal href="https://update.easycode.ai/download/stable/02ec53339c7805842c6fbccb6039d71823f2b9d6/EasyCode-Installer.exe">
