...
<Tabs>
  <Tab title="MacOS">
    <CardGroup cols={2}>
      <Card title="Apple Silicon" icon="download" horizontal href="https://drive.google.com/file/d/1tWzquHEw_6S9-7YWPal7UaK5EW87jWw-/view?usp=drive_link">
        M Series Macs
      </Card>
  ...
  <Tab title="Windows">
    <CardGroup cols={2}>
      <Card title="Windows x64" icon="download" horizontal href="https://drive.google.com/file/d/1UovA4n0MNyZ00XIvjt65qaUs_EAc_w-v/view?usp=drive_link">
