...
<CardGroup cols={2}>
  <Card title="Debugging" icon="arrow-up-right" iconType="regular" href="../guides/debugging.mdx">
    Fix errors the right way.
  </Card>
  <Card title="Connect APIs" icon="arrow-up-right" href="../guides/connect-APIs.mdx">
