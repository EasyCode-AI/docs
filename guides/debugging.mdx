...
<Frame height="100%">
  <img src="/images/guides/compile-error.jpg" alt="Compile Error Screenshot" style={{height: '100%', width: '100%', objectFit: 'contain'}} />
</Frame>
...
<Frame height="100%">
  <video src="/images/guides/runtime-error.mp4" controls style={{height: '100%', width: '100%', objectFit: 'contain'}} />
</Frame>
...
<Frame height="100%">
  <video src="/images/guides/visual-edit.mp4" controls style={{height: '100%', width: '100%', objectFit: 'contain'}} />
</Frame>
...
<Frame height="100%">
  <video src="/images/guides/interactive-debug.mp4" controls style={{height: '100%', width: '100%', objectFit: 'contain'}} />
</Frame>
